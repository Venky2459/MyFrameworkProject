...
public class Assignment {
	...
	String price = driver.findElement(By.xpath("//label[contains(text(),'Price:')]/following::span[1]")).getText();
	...
	String OrderNo = driver.findElement(By.xpath("//strong[contains(text(),'Your order has been successfully processed!')]/following::ul[1]/li[1]")).getText();
